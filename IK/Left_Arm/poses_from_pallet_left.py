...
from mover_ladrillo_left import MoverLadrillo
...
urdf_path = os.path.abspath("g1_29dof_with_hand_rev_1_0.urdf") #URDF modificado para Aura
...
ets = robot.ets(end="left_hand_index_1_link")
