...
urdf_path = os.path.abspath("g1_dual_arm_right.urdf") #URDF modificado para Aura
...
np.savetxt("q_steps_pallet_LM_right.csv", q_steps, delimiter=",")
print("Pasos de IK guardados en 'q_steps_pallet_LM_right.csv'.")